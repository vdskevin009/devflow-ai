...
Open [DevFlow AI](https://vdskevin009.github.io/devflow-ai/) in your phone browser. Bookmark it or use Add to Home Screen. FamilyHub data, DevFlow drafts and saved scenarios are specific to the browser/device; they do not sync automatically.
...
2. Connect GitHub and allow access to **vdskevin009/devflow-ai**. If the repository is missing, update the GitHub connection's selected repositories. Do not create or paste a personal access token into a chat.
...
4. Open [Actions](https://github.com/vdskevin009/devflow-ai/actions). The main-branch run performs checks and then deploys. Wait for the deploy job to succeed.
